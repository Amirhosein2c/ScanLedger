...
const WelcomeOnboarding = () => {
  ...
  type InstallLabelKey =
    | "welcome.install.button.default"
    | "welcome.install.button.fallback";
  const [deferredPrompt, setDeferredPrompt] =
    useState<BeforeInstallPromptEvent | null>(null);
  const [installLabelKey, setInstallLabelKey] = useState<InstallLabelKey>(
    "welcome.install.button.default"
  );
  ...
  useEffect(() => {
    ...
    const navigatorStandalone = Boolean(
      (globalWindow.navigator as Navigator & { standalone?: boolean })
        .standalone
    );
        ...
        <div className="-mt-16 z-10 flex flex-col items-center px-6 pb-6 text-center">
          <div className="mb-4">
            ...
            >
              ...
              />
              <path
                d="M26 20L20 26H24C25.1046 26 26 25.1046 26 24V20Z"
                fill="#38E07B"
              />
              <path
                d="M28 32H38"
